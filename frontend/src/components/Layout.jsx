...
const Layout = ({ onLogout, user }) => {
  ...
  const fetchTasks = useCallback(async () => {
    ...
    try {
      ...
      const { data } = await axios.get(
        `${import.meta.env.VITE_API_BASE_URL}/api/tasks/gp`,
        {
  ...
  const StatCard = ({ title, value, icon }) => (
    <div
      className="p-2 sm:p-3 rounded-xl bg-white shadow-sm border 
    border-purple-100 hover:shadow-md transition-all
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div className="min-w-0">
          <p
            className="text-lg sm:text-xl font-bold bg-gradient-to-br from-fuchsia-500 to-purple-600
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="xl:col-span-1 space-y-3 sm:space-y-6">
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100">
              <h3
                className="text-base sm:text-lg font-semifold mb-3 sm:mb-4 text-gray-800
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center justify-between text-gray-700">
                  <span className="text-ms sm:text-sm font-medium flex items-center gap-1.5">
                    <Circle className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-purple-500 fill-purple-500" />
                    Task Progress
                  </span>
                  <span
                    className="text-xs bg-purple-100 text-purple-700 px-1.5 py-0.5 sm:px-2
                  rounded-full"
                  >
                ...
                <div className="relative pt-1">
                  <div className="flex gap-1.5 items-center">
                    <div
                      className="flex-1 h-2 sm:h-3 bg-purple-100 rounded-full
                    over-flow-hidden"
                    >
                      <div
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100">
              <h3
                className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-gray-800 flex
  items-center gap-2"
              >
