...
const API_BASE = `${import.meta.env.VITE_API_BASE_URL}${import.meta.env.VITE_API_TASKS}`;
const TaskModal = ({ isOpen, onClose, taskToEdit, onSave, onLogout }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white border border-purple-100 rounded-xl max-w-md w-full
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div
              className="flex items-center border border-purple-100 rounded-lg px-3 py-2.5
          ...
          <button type="submit" disabled={loading}
           className="w-full bg-gradient-to-br from-fuchsia-500 to-purple-500 text-white
